...
Namespace InheritedUserControl
	Partial Public Class ProductsGridControl
		...
		Private Sub InitializeComponent()
			...
			Me.northwindDataSet = New InheritedUserControl.NorthwindDataSet()
			Me.productsBindingSource = New System.Windows.Forms.BindingSource(Me.components)
			Me.productsTableAdapter = New InheritedUserControl.NorthwindDataSetTableAdapters.ProductsTableAdapter()
			...
			Me.gridView1.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() { New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.colCategoryID, DevExpress.Data.ColumnSortOrder.Ascending), New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.colProductName, DevExpress.Data.ColumnSortOrder.Ascending)})
			' 
			' northwindDataSet
			' 
...
'			Me.Load += New System.EventHandler(Me.ProductsGridControl_Load);
		...
		Private productsTableAdapter As InheritedUserControl.NorthwindDataSetTableAdapters.ProductsTableAdapter
	End Class
End Namespace
